...
if (!verifyRecaptcha($recaptchaResponse)) {
    ...
    giveLogEvent('change_email_api_recaptcha_failed', 400, 'reCAPTCHA verification failed');
    exit;
}
...
if ($email === '') {
    ...
    giveLogEvent('change_email_api_invalid_email', 400, 'Invalid email address');
    exit;
}
...
if ($userId !== null) {
    $generatedToken = generateCredToken($userId, $email);
